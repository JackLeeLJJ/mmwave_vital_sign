...
# 加载数据
mmwave_data = np.load("../data/mmwaveData/trainData/down_mmwaveData/train_wake/mmwave_0304_crf_0_0_0.npy")
ecg_data = np.load("../data/mmwaveData/trainData/ecgData/ECG_Clean_0304_crf_0_0.npy")
ecg_data/=1000
# 创建画布和坐标轴
